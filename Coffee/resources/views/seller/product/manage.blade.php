    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            <div class="wg-filter flex-grow">
                <form class="form-search" id="search-form" action="{{ route('personnel.product.manage') }}" method="GET">
                    <fieldset class="name">
            ...
            <form action="{{ route('personnel.product.manage') }}" method="GET" class="form-inline">
