                    ...
                    <div class="center">
                        <div class="center-item">
                            ...
                            <ul class="menu-list">
                                ...
                                <li
                                    class="menu-item {{ request()->routeIs('personnel.order.history') ? 'active' : '' }}">
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li
                                            class="sub-menu-item {{ request()->routeIs('personnel.store') ? 'active' : '' }}">
                                            <a href="{{ route('personnel.store') }}" class="">
                                                <div class="text">Create</div>
                                            </a>
                                        </li>
                                        <li
                                            class="sub-menu-item {{ request()->routeIs('personnel.store.manage') ? 'active' : '' }}">
                                            <a href="{{ route('personnel.store.manage') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li
                                            class="sub-menu-item {{ request()->routeIs('product.manage_product_review') ? 'active' : '' }}">
                                            <a href="{{ route('product.manage_product_review') }}" class="">
