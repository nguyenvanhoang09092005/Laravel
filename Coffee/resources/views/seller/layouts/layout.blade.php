...
<head>
    ...
    <link rel="stylesheet"
        ...
        integrity="sha384-KyZXEAg3QhqLMpG8r+8fhAXLR7jc/2Ji8c5i8Gxs7iI6Vtb2j6bP1g5c4pNTF1+7R9" crossorigin="anonymous">
                ...
                <div class="section-menu-left">
                    ...
                    <div class="center">
                        <div class="center-item">
                            <div class="center-heading">Page Seller </div>
                            <ul class="menu-list">
                                <li class="menu-item {{ request()->routeIs('personnel') ? 'active' : '' }}">
                                    <a href="{{ route('personnel') }}" class="">
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li
                                            class="sub-menu-item {{ request()->routeIs('personnel.product.manage') ? 'active' : '' }}">
                                            <a href="{{ route('personnel.product.manage') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li
                                            class="sub-menu-item {{ request()->routeIs('Personnel.Order.History') ? 'active' : '' }}">
                                            <a href="{{ route('Personnel.Order.History') }}" class="">
                                ...
                                <li class="menu-item"
                                    {{ request()->routeIs('Personnel.Manage.User') ? 'active' : '' }}>
                                    <a href="{{ route('Personnel.Manage.User') }}" class="">
                                        <div class="icon"><i class="icon-user"></i></div>
                                        <div class="text">Manager User</div>
                                    </a>
                                </li>
                                <li class="menu-item"
                                    {{ request()->routeIs('Personnel.Manage.Promotions') ? 'active' : '' }}>
                                    <a href="{{ route('Personnel.Manage.Promotions') }}" class="">
                                        <div class="icon"><i class="icon-file-plus"></i></div>
                                        <div class="text">Manager Promotions</div>
                                    </a>
                                </li>
