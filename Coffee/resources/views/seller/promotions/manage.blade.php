    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            <div class="wg-filter flex-grow">
                <form class="form-search" method="GET" action="{{ route('Personnel.Manage.Promotions') }}">
        ...
        <form action="{{ route('Personnel.Manage.Promotions') }}" method="GET" class="form-inline">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="list-icon-function"
                                    ...
                                    <a href="{{ route('Personnel.Manage.Promotions.Show', $promotion->id) }}">
                                        <div class="item view">
                                            <i class="icon-eye"></i>
                                        </div>
                                    </a>
