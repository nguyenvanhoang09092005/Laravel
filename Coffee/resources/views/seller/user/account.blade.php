...
@section('seller_layout')
    ...
    <div class="wg-box">
        ...
        @endif
        <form class="form-edit-profile" method="POST" enctype="multipart/form-data" action="{{ route('seller.user.update') }}">
            @csrf
            @method('PUT')
            <div class="wg-box">
    ...
    <div class="wg-box mt-5">
        ...
        @endif
        <form action="{{ route('seller.user.change_password') }}" method="POST">
            @csrf
            @method('PUT')
